var questions = [
  ...
  "Which canteen is the best",
  "Where can i get my id Card",
  "which is the mechanical department",
];
var debates = [
  "Covid",
  "Hijab Row",
...
questions.forEach((item) => {
  qList1.innerHTML +=
    '<a style="text-decoration:none;color: inherit;" href=\'/askbms/question/' +
    item +
    '\'><div class="cardQ mb-2 border"><div class="card-body "><h5 class="card-title">' +
    item +
    '</h5><h6 class="card-subtitle">Tags : Placements, Teachers, Seniors</h6><p class="card-text">I am a 2nd year student in the ME department and wanted to know how and when the placements are conducted in our college</p></div></div></a>';
});
q2.forEach((item) => {
  qList2.innerHTML +=
    '<a style="text-decoration:none;color: inherit;" href=\'/askbms/question/' +
...
debates.forEach((item) => {
  debateList.innerHTML +=
    '<a href="/askbms/debate/' +
    item +
    '" class="list-group-item list-group-item-action text-center debateItem">' +
    item +
    "</a>";
});
